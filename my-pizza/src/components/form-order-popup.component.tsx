  ...
  return (
    ...
    >
      <span
        ...
        className="form-order--close"
        onClick={() => onVisibleForm()}
      >
        ×
      </span>
      <form className="form-order--form" onSubmit={handleSubmit}>
        <p className="form-order--label">
          Для заказа: введите свой телефон и мы вам перезвоним
        </p>
        <input
        ...
        />
        {error && (
          <p data-testid="error-message-window" className="form-order--error">
            {error}
          </p>
        )}
