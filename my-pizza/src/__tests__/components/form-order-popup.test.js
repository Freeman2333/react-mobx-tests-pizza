...
import FormOrderPopup, {
  normalizeInput,
} from '../../components/form-order-popup.component';
import userEvent from '@testing-library/user-event';

describe('FormOrderPopup Component', () => {
  describe('FormOrderPopup', () => {
    it('form not visible', () => {
      const { container } = render(<FormOrderPopup isVisibleForm={false} />);
    ...
    it('change input value & get phone mask value', () => {
      const { container } = render(<FormOrderPopup isVisibleForm={true} />);
