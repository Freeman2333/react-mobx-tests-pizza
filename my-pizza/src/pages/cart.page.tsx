...
import FormOrderPopup from '../components/form-order-popup.component';
...
const Cart = (props: ICart) => {
  ...
  const handleMinusItem = (index: number) => props.cart!.minusCartItem(index);

  const toggleVisiblePopup = () => setIsComponentVisible(!isComponentVisible);

  const handlePlusItem = (index: number) => props.cart!.plusCartItem(index);
